 ...
 *
 * v1.10 completes the original 3.0 EX mobile input surface. Script tracing of
 * the pinned SWF confirms that the four main professions poll Ctrl, Shift,
 * Space and B in addition to the twelve normal skill shortcuts. Keep these as
 * HOLD buttons because several original AS2 handlers poll Key.isDown() on a
 * frame boundary; releasing them via the existing pointer router is therefore
 * safer than synthesizing a short pulse.
 */
public final class ControlLayoutConfig {
    ...
    public static ControlLayoutConfig modern() {
        ...
        // Runtime supplies page-one A..H and page-two Q..Y.
        ...
        // Compact 2x2 EX cluster. These captions stay class-neutral because the
        // actual move bound to each key changes with profession/equipment state.
